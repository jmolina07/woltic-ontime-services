...
public class CompanyController {
	...
	@GetMapping(path="api/company2/{id}")
	public void getCompanyByID2(@PathVariable("id") int id){
		try {
	...
	@PostMapping(path = "api/no_branch/add_company", consumes = MediaType.TEXT_PLAIN_VALUE,
			 produces = {MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<Response> addCompanyWithoutBranch(@RequestBody String json) 
