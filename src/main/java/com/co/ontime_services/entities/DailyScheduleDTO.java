...
//------------------------------------------------------------------------------------------------------------------
	...
	public DailyScheduleDTO(int schedule_id, int client_fk, int branch_fk, int service_fk, int professional_fk,
		int resource_fk, Date date, String initial_hour, String final_hour, int turn, int state) {
		super();
	...
	public DailyScheduleDTO(int client_fk, int branch_fk, int service_fk, int professional_fk, int resource_fk,
	...
	public int getResource_fk() {
		return resource_fk;
	}

	public void setResource_fk(int resource_fk) {
		this.resource_fk = resource_fk;
	}
